...
class SegPOSDepBertTransformer(nn.Module):
    ...
    def __init__(self, directory, tokenizer, bert=None, n_layers=3, 
        ...
        if directory:
            ...
            self.model = make_seg_pos_dep_bertmodel(bert=bert,
                                        N=n_layers,
                                        d_ff=d_ff,
                                        h=head,
                                        dropout=dropout)
        ...
        self.model.cuda()
        self.clf.cuda()
        self.name = 'SegPOSDepBertTransformer'
        self.freeze_encoder()
